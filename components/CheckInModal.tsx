      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="space-y-4 text-base leading-relaxed text-gray-800">
            ...
            <p>
              Your participant ID is <strong>{participant.displayId}</strong>{" "}
              and your team ID is{" "}
              <strong>
            ...
            <p>
              Please wear your sticker. It contains your table numbers. You can
              use the map in the packet to find your team table.
            </p>
          </div>
        </div>
      </div>
