            ...
            <div className="flex flex-col gap-4 flex-1">
                ...
                <ol className="list-decimal ml-4">
                    ...
                    <li>
                        ...
                        policy is twofold: to make the subjects more competitive
                        and balanced, and to perhaps introduce other topics of
                        math not normally found in the classroom setting.
                    </li>
                    <ol className="list-decimal ml-8">
                        <li>
                            Each Upper division ({upper}) team can have no more
                ...
                <ol className="list-decimal ml-4">
                    ...
                    <li>
                        ...
                        enjoyment and <b>winners will not receive awards</b>{" "}
                        (though fun swag can be won during Fun round) .
                    </li>
                </ol>
                ...
                <ol className="list-decimal ml-4">
                    <li>
                        ...
                        <Math eq="n" />
                        th term of a sequence, where <Math eq="n" /> is a
                        positive integer. For example, in the sequence{" "}
                        <Math eq="1, 1, 2, 3, 5, \ldots" />,{" "}
                        <Math eq="a_1=1, a_2=1, a_3=2, a_4=3" />, and so on.
                    </li>
                    <li>
                        <b>Factorial notation</b>: <Math eq="n!" /> refers to
                        the product of all positive integers up through{" "}
                        <Math eq="n" />. That is:{" "}
                    ...
                    <li>
                        ...
                        &quot; or states that &quot;
                        <Math eq="AB = 10" />
                        &quot;, this refers to the length of line{" "}
                        <Math eq="AB" /> or the distance between the points{" "}
                        <Math eq="A" /> and <Math eq="B" />.
                    </li>
                </ol>
                <h2 className="text-xl font-bold font-sans">
                ...
                <ol className="list-decimal ml-4">
                    <li>
                        A circle is <b>inscribed</b> in a shape if it touches
                        each side of the shape at one point and is inside the
                        shape. A circle that is inscribed in a triangle is
                        called the triangle&apos;s <b>incircle</b>. A circle is{" "}
                    ...
                    <li>
                        The <b>multiples</b> of a number are the positive
                        numbers that divide into it evenly. For example, the
                        multiples of 3 are <Math eq="3" />, <Math eq="6" />,{" "}
                        <Math eq="9" />, <Math eq="12" />, and so on. The{" "}
                        <b>factors</b> or <b>divisors</b> of a number are the
                        positive numbers that it divides into evenly. For
                        example, the factors of <Math eq="6" /> are{" "}
                        <Math eq="1" />, <Math eq="2" />, <Math eq="3" />, and{" "}
                        <Math eq="6" />.
                    </li>
                    <li>
                        If two numbers or objects are selected{" "}
                        <b>independently and at random</b>, this means that they
                        are selected at random, and that how one is selected
                        doesn&apos;t affect how the other is selected.
                    </li>
                    <li>
                        A <b>real number</b> is a rational number or an
                        irrational number. <Math eq="-1" />, <Math eq="2.5" />,
                        and <Math eq="\pi" /> are all real numbers. Unless
                        you&apos;ve learned about complex numbers, every number
                        you know of is a real number.
                    </li>
                </ol>
                <h2 className="text-xl font-bold font-sans">
                    Answering Questions
                ...
                <ol className="list-decimal ml-4">
                    <li>
                        For fractional answers whose numerator and denominator
                        are both integers, fractions should be written in
                        simplified form. We do not accept mixed fractions.
                    </li>
                    <li>
                        Rationalizing denominators is <b>optional</b>.
                    </li>
                    <li>
                        For short finite decimals, we accept both the fractional
                        and the exact decimal form.
                    </li>
                    <li>
                        For infinite or long finite decimals, we strongly prefer
                        the fractional form. However, bar notation for repeating
                        infinite decimals is accepted.
                    </li>
                    <li>
                        For questions requesting the answer in terms of
                        variables, use the variables as defined in the problem.
                    </li>
                    <li>
                        &quot;Divisors&quot; refers to positive integral
                        divisors unless otherwise specified.
                    </li>
                    <li>
                        If a question specifies an answer form, such as{" "}
                        <Math eq="a + b \sqrt{2}" />, please adhere to the
                        specified form.
                    </li>
                </ol>
                <p>
                ...
                <ol className="list-decimal ml-4">
                    <li>
                        A student’s <b>overall individual score</b> is the
                        weighted sum of the two subject tests that they have
                        taken. The <b>top 5 individuals</b> in each division
                    ...
                    <li>
                        High-placement ties will be broken using tiebreaker
                        rounds. Tiebreaker rounds will be held during the Fun
                        Round.
                    </li>
                    <li>
                        The <b>team score</b> is a weighted sum of the
                        Individual Round, Team Round, and Guts Round scores. The
                        <b>top 5 teams</b> in each division will be recognized.
                    </li>
                    <li>
                        The highest scoring 6th grade student in the{" "}
                        <b>{lower}</b> (lower) division will receive the{" "}
                        <b>Young Scholar Award</b>.
                    </li>
                </ol>
                <p>
